...
public class RentListFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(536, 60, 210, -1));
    ...
    private void SearchFieldTxtfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchFieldTxtfActionPerformed
        ...
        if (searchKeyword.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Enter the client name or vehicle model to search.", "Input Required", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        FROM Rentals
        LEFT JOIN client ON Rentals.Client_ID = Client.ID
        WHERE client.full_name LIKE ? OR Rentals.Model LIKE ?
        """;
        ...
        try (Connection con = DriverManager.getConnection(dbUrl, dbUser, dbPassword);
            ...
            try (ResultSet rs = pst.executeQuery()) {
                ...
                if (!found) {
                    JOptionPane.showMessageDialog(this, "No vehicles found for " + searchKeyword, "No Results", JOptionPane.INFORMATION_MESSAGE);
                }
            }
    ...
    private void SearchFieldTxtfKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SearchFieldTxtfKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (searchKeyword.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Enter the client name or vehicle Model", "Input Required", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            try (Connection con = DriverManager.getConnection(dbUrl, dbUser, dbPassword);
                ...
                try (ResultSet rs = pst.executeQuery()) {
                    ...
                    while (rs.next()) {
                        ...
                        model.addRow(new Object[]{rentalID, VehicleID, rentedDate, brand, modelStr, clientName});
                    }
    ...
    private void loadRentedVehicles() {
        ...
        String query = """
            SELECT 
                ...
                COALESCE(client.full_name, 'No Client') AS Client
            FROM Rentals
            LEFT JOIN client ON Rentals.Client_ID = Client_ID
        """;
